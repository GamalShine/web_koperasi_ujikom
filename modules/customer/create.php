...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $query = "INSERT INTO customer (nama_customer, alamat, no_telepon) VALUES (?, ?, ?)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("sss", $nama_customer, $alamat, $no_telepon);
                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_customer" name="nama_customer" 
                                           value="<?php echo isset($_POST['nama_customer']) ? htmlspecialchars($_POST['nama_customer']) : ''; ?>" required>
                                </div>
                                <div class="form-group">
